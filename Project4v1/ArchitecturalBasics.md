Following is the order of the concepts i would use to experiment with

1. Decide on the number of layers to be used, number of channels and parameters. Try to minimize the parameters depending on the complexity of the input image size.
   1. How many layers,
   2. MaxPooling,
   3. 1x1 Convolutions,
   4. 3x3 Convolutions,
...
2. Optimize using transition layers

   1. Batch Normalization,
   2. Image Normalization,
   3. DropOut

3. Optimize the learning rates
...
10. Kernels and how do we decide the number of kernels?
...
18. When do we introduce DropOut, or when do we know we have some overfitting
...
19. The distance of MaxPooling from Prediction,
...
25. LR schedule and concept behind it
...
27. etc (you can add more if we missed it here)
